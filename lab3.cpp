...
class node{
	...
	//constructor --- turns pointers to null
	node(){
		next=NULL;
		prev=NULL;
		}
...
class list{
	...
	//Rules- nodes will be doubly linked 
	
	//insert a node at the end
	void insert(int val){
		node* temp=new node;//new helps to creates an object of node type in heap and returns its adress
		temp->data=val;	
		if(head==NULL)     //if head is null--- no list
		{
			head=temp;
			}
